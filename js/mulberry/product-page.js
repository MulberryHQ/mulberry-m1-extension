jQuery(document).ready(function() {
    var MulberryProductPage = {
        ...
        {
            var configurableProductsHandler = (typeof spConfig !== 'undefined') ? spConfig : false;

            if (!configurableProductsHandler) {
                return;
            }

            return configurableProductsHandler ? configurableProductsHandler.config.simple_skus[this.getSimpleProductId()] : window.mulberryProductData.originalSku;
        },
        ...
        {
            var customOptionsHandler = (typeof opConfig !== 'undefined') ? opConfig : false,
                result = '';
        ...
        updateMulberryProduct: function updateMulberryProduct(newPrice)
        {
            ...
            this.productUpdateTimer = setTimeout(function () {
                if (this.hasConfigurationChanges(newConfig)) {
                    ...
                    jQuery('#warranty').attr('name', 'warranty[' + window.mulberryProductData.product.id + ']');
            ...
            if (('undefined' !== typeof productAddToCartForm) && productAddToCartForm) {
                ...
                productAddToCartForm.submit = function (button, url) {
                    if (this.validator.validate()) {
                        ...
                        var e = null;
                        try {
                            if (self.mulberryOverlayActive || !window.mulberry || !window.mulberry.mulberryModal || !window.mulberry.mulberryInline) {
                                this.form.submit();
                            }
